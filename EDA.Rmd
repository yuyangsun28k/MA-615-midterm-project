...
```{r warning=FALSE}
p <- ggplot(state_damage, aes(x = Total_Damage_Property, y = Total_Damage_Crops)) +
  geom_point(aes(text = STATE, color = STATE), size = 3, alpha = 0.6) +
  labs(title = "Scatter Plot of Property vs. Crop Damage by State",
